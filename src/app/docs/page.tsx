...
const DOCS_DESCRIPTION =
	"Documentation for @danetaylor3/gradients, a React component for generative gradient avatars. Installation, props, patterns, examples, and engine helpers.";
...
const docsJsonLd = {
	...
	"@graph": [
		...
		},
		{
			...
			headline: "@danetaylor3/gradients: Documentation",
			description:
				"Installation, props, patterns, usage, and engine helpers for @danetaylor3/gradients, a React component for generative gradient avatars.",
			url: `${SITE}/docs`,
