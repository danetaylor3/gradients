...
// Published version of @danetaylor3/gradients, read from the package itself
...
export const metadata: Metadata = {
	...
	applicationName: "@danetaylor3/gradients",
	description: DESCRIPTION,
	keywords: [
		"generative avatars",
		"generative gradient avatars",
		"gradient avatars",
		"@danetaylor3/gradients",
