...
function SeoContent() {
	return (
		<section className="sr-only">
			<p>
				<strong>@danetaylor3/gradients</strong> is a free, open-source React
			...
			<p>
				Install with <code>npm i @danetaylor3/gradients</code>, then render a{" "}
			...
			<h2>What is @danetaylor3/gradients?</h2>
			<p>
			...
			<p>
				...
				@danetaylor3/gradients renders gradient/mesh fills on canvas with zero
...
/**
 * Copyable `npm i @danetaylor3/gradients` command, the hero's primary CTA.
