...
const CHANGELOG_DESCRIPTION =
	"Release notes for @danetaylor3/gradients: every version of the generative gradient avatar component, what changed, and what is coming next.";
const CHANGELOG_OG_DESCRIPTION =
	"Release notes for @danetaylor3/gradients, every version, what changed, and what is coming next.";
...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		title: "Changelog | @danetaylor3/gradients",
...
const changelogJsonLd = {
	...
	"@graph": [
		...
		...CHANGELOG.filter((entry) => entry.date).map((entry) => ({
			...
			headline: `@danetaylor3/gradients ${entry.version}: ${entry.title}`,
