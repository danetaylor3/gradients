...
export const FAQ: { q: string; a: string }[] = [
	{
		q: "Is @danetaylor3/gradients free?",
	...
	},
	{
		...
		a: "Boring Avatars renders SVG shapes; @danetaylor3/gradients renders gradient/mesh fills on an HTML canvas with zero dependencies and no network requests.",
	},
];
