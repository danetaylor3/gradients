...
export const SNIPPETS = {
	usage: {
		lang: "tsx",
		code: `import { GradientAvatar } from "@danetaylor3/gradients";
...
<GradientAvatar seed="studio" size={84} p3 />`,
	...
	engine: {
		lang: "tsx",
		code: `import { gradientToDataURL, generatePalette } from "@danetaylor3/gradients";
...
export const INSTALL = [
	{ id: "pnpm", command: "pnpm add @danetaylor3/gradients" },
	{ id: "npm", command: "npm i @danetaylor3/gradients" },
	{ id: "yarn", command: "yarn add @danetaylor3/gradients" },
	{ id: "bun", command: "bun add @danetaylor3/gradients" },
] as const;
