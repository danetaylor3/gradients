...
<p align="center">
  ...
  <a href="https://bundlephobia.com/package/@danetaylor3/gradients"><img src="https://img.shields.io/bundlephobia/minzip/@danetaylor3/gradients?color=000&labelColor=000&label=gzipped" alt="gzipped size" /></a>
...
```ts
import { gradientToDataURL, generatePalette } from "@danetaylor3/gradients";
